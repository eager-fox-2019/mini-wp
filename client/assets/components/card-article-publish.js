Vue.component('card-article-publish', {
    props: ['article'],
    data(){
        return {}
    },
    ...
    template: `
    <div class="row d-flex flex-row-reverse" style="margin-right: 10px; margin-left: 30px">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-5 offset-sm-1">
                        <img class="img-thumbnail" :src="article.thumbnail" alt="thubmnail" style="width: 80px; height: 100px; margin-top: -10px" />
